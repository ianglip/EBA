...
from M24.model24_1 import Model24
#***********************************************
...
from M135.Testconfig135_1 import (
    ROOT,
    PK_PATH,
    PK_FEATURE_SIZE,
    max_pkt_len,
...
#***********************************************
from M1234.Testconfig1234_1 import (
    ROOT,
    #PK_PATH,
    #PK_FEATURE_SIZE,
    #max_pkt_len,
...
file_names=[model12,model24,model234,model135,model345,model1234,model1345]#,model2345,model12345]
...
def predict():
    ...
    #print(TEST_SET_LIST)
    with open(CHECKPOINT_PATH1 / "PID.lst", "w") as file:
       file.write(f"{TEST_SET_LIST}")
